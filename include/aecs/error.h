...
#define AECS_ERROR_SECRET_CREATE_DATA_NOT_SUPPORT           AECS_ERROR(0xA419)
...
#define AECS_ERROR_SECRET_GET_INTERNAL                      AECS_ERROR(0xA446)
...
#define AECS_ERROR_SECRET_GETPUB_PRIVATE                    AECS_ERROR(0xA456)
#define AECS_ERROR_SECRET_GETPUB_NEVER_EXPORTED             AECS_ERROR(0xA457)
...
#define AECS_ERROR_STORAGE_ORM_INVALID_SESSION              AECS_ERROR(0xAA51)
#define AECS_ERROR_STORAGE_ORM_INVALID_PATH_FORMAT          AECS_ERROR(0xAA52)
#define AECS_ERROR_STORAGE_ORM_INVALID_PATH_PREFIX          AECS_ERROR(0xAA53)
#define AECS_ERROR_STORAGE_ORM_CREATE                       AECS_ERROR(0xAA54)
#define AECS_ERROR_STORAGE_ORM_DELETE                       AECS_ERROR(0xAA55)
#define AECS_ERROR_STORAGE_ORM_UPDATE                       AECS_ERROR(0xAA56)
#define AECS_ERROR_STORAGE_ORM_LIST                         AECS_ERROR(0xAA57)
#define AECS_ERROR_STORAGE_ORM_GETVALUE                     AECS_ERROR(0xAA58)
#define AECS_ERROR_STORAGE_ORM_CHECK_EXIST                  AECS_ERROR(0xAA59)
#define AECS_ERROR_STORAGE_ORM_CREATE_NAME_EXIST            AECS_ERROR(0xAA5A)
#define AECS_ERROR_STORAGE_ORM_INVALID_PARAMETERS           AECS_ERROR(0xAA5B)
#define AECS_ERROR_STORAGE_ORM_INVALID_SQL_ITEMS            AECS_ERROR(0xAA5C)
